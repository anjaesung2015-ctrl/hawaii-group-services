...
const I18N = {
  ko: {
    ...
    tgDisconnect: '연결 해제',
    tgOpen: '텔레그램 열기',
    tgGuide: '버튼을 누르면 텔레그램이 열립니다. 시작을 누르면 끝나요. (10분 안에)',
    tgOff: '관리자가 아직 알림 봇을 설정하지 않았습니다.',
    alarm: '알람',
    alarmOn: '알람 켜기',
    alarmTime: '보낼 시각',
  ...
  mn: {
    ...
    delAsk: 'Устгах уу?',
    tgConnect: 'Telegram холбох',
    tgConnected: 'Холбогдсон',
    tgDisconnect: 'Салгах',
    tgOpen: 'Telegram нээх',
    tgGuide: 'Товч дарвал Telegram нээгдэнэ. Start дарахад дуусна. (10 минутын дотор)',
    tgOff: 'Админ мэдэгдлийн ботыг хараахан тохируулаагүй байна.',
    alarm: 'Сэрүүлэг',
