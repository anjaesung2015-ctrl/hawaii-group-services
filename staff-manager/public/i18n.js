...
const I18N = {
  ko: {
    ...
    staffAdd: '직원 추가',
    staffName: '이름',
    staffPw: '첫 비밀번호(4자 이상)',
    staffSave: '추가',
    staffQuit: '퇴사',
    staffBack: '복귀',
    staffRename: '이름변경',
    staffDup: '같은 이름이 있습니다',
    staffAdded: '추가했습니다',
    staffQuitNote: '퇴사해도 그동안 기록은 남습니다',
    scTitle: '{m}월 직원 종합',
    scReport: '보고',
    scTask: '할 일',
    scAsg: '지시',
  ...
  mn: {
    ...
    score: 'Нэгтгэл',
    staffMgr: 'Ажилтан',
    staffAdd: 'Ажилтан нэмэх',
    staffName: 'Нэр',
    staffPw: 'Анхны нууц үг (4-өөс дээш)',
    staffSave: 'Нэмэх',
    staffQuit: 'Гарсан',
    staffBack: 'Буцаах',
    staffRename: 'Нэр солих',
    staffDup: 'Ийм нэр бүртгэлтэй байна',
    staffAdded: 'Нэмлээ',
    staffQuitNote: 'Гарсан ч өмнөх бүртгэл хадгалагдана',
